...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_kun_vain_kaksi_ja_puoli_euroa(self):
        self.kortti1 = Maksukortti(2.5)
        self.kortti1.syo_edullisesti()
        self.assertEqual(str(self.kortti1), 'Kortilla on rahaa 0.0 euroa')

    def test_syo_maukkaasti_kun_vain_nelja_euroa(self):
        self.kortti1 = Maksukortti(4)
        self.kortti1.syo_maukkaasti()
        self.assertEqual(str(self.kortti1), 'Kortilla on rahaa 0 euroa')