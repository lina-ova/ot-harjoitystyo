...
class SurviveTask:
    ...
    def riddle(self):
        ...
        """Funktio, joka palauttaa tehtävänannon
    ...
    def answer(self):
        ...
        """funktio, joka palauttaa oikean vastauksen
    ...
    def check_user_answer(self,correct, users):
        """Funktio, joka tarkistaa täsmäälö oikea vastaus pelaajan vastausta

        Args:
            correct ([str]): [oikea vastaus]
            users ([str]): [pelaajan vastaus]

        Returns:
            [str]: [tieto seuraavasta näkymästä]
        """
