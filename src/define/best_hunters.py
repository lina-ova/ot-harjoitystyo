...
class Hunters:
    ...
    def get_from_history(self):
        """Funktion, joka palauttaa kaikkien pelaajien tiedot tietokannasta

        Returns:
            [list]: [lista(Tuple(Pelaajan nimi, kerätty määrä rahaa, tila)......)]
        """
    ...
    def get_three_best_from_history(self):
        ...
        """Funktio, joka palauttaa kolmen parhaan pelaajan suoritukset tietokannasta

        Returns:
            [lista]: [Text(Name:'Pelaajan nimi' Treasures:'kerätty määrä' Status: 'Elossa/Koullut')]
        """
    ...
    def check_name_unique(self, name):
        ...
        """Funktio, joka tarkistaa onko nimi varattu
        Args:
    ...
    def get_hunter(self, name):
        ...
        Returns:
            pelaajan tiedot teksti muodossa:
