...
from tkinter import messagebox, StringVar, PhotoImage, Label, Button, Frame, Entry, BOTH, LEFT, CENTER
from define.best_hunters import Hunters

class WriteView:

    """Luokka, joka vastaa näkymästä, jossa pelaaja tallentaa suorituksensa tietokantaan
    """
