from tkinter import PhotoImage, messagebox, constants, Label, Button, Frame

class SurviveDigestView:

    """Luokka, joka alustaa näkymän, jossa pelaaja on yrittänyt suoritaa tehtävän ja vastannut oikein tai väärin
    """
    ...
    def __init__(self, root, hello, play, result, answer, write):
        ...
        Args:
            ...
            play ([funktio]): [käsky, joka avaa pelin pelaamisen jatkonäkymän]
    ...
    def _last_question(self):
        ...
        """Funktio, joka varmistaa pelaajlta, jos se haluaa kirjoittaa nimensa tietokantaan pelistä lähtiessä
        """
    ...
    def _congrats(self):
        ...
        label=Label(master=self._frame, text='Congrats!')
    ...
    def _pooped(self):
        ...
        label=Label(master=self._frame, text='You were pooped out')
    ...
    def _survived(self):
        ...
        label=Label(master=self._frame, text='You survived and still got your treasures')
    ...
    def _worth_it(self):
        ...
        label=Label(master=self._frame, text='But was it all worth it?')
    ...
    def _initialize_survived(self):
        ...
        background=Label(master=self._frame, image=self._survive_bg)
    ...
    def _correct_answer(self):
        ...
        label_info=Label(master=self._frame, text='Correct answer was:')
        label_answer=Label(master=self._frame, text=self._answer)
    ...
    def _unfortune(self):
        ...
        label=Label(master=self._frame, text='Unfortunately you could not survive and got digested')
        label.place(relx=0.5, rely=0.45, anchor=constants.CENTER)
    ...
    def _initialize_digest(self):
        ...
        background=Label(master=self._frame, image=self._digest_bg)
        background.place(x=0,y=0,relwidth=1, relheight=1)
